...
export const metadata: Metadata = {
  ...
  keywords: ["mental wellness", "JEE", "NEET", "UPSC", "student stress", "AI companion", "mood tracker"],
  authors: [{ name: "MindMate" }],
  openGraph: {
    title: "MindMate — AI Wellness for Exam Warriors",
    description: "Track your mental wellness through exam preparation with AI-powered support",
    type: "website",
  },
